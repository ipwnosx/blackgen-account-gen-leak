...
<div class="content">
  ...
  <div class="block block-rounded block-bordered">
      <div class="block-header block-header-default">
          <h3 class="block-title">List of all connections</h3>
      </div>
      <div class="block-content block-content-full">
          ...
          <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
              ...
              <tbody>
                  ...
                  <?php
                  $rLogin = $odb->query('SELECT * FROM loginlogs');
                  foreach ($rLogin as $rLogin) {
                    ?>
                    <tr>
                        <td class="text-center"><?php echo $rLogin['username']; ?></td>
                        <td class="d-none d-sm-table-cell">
                          <?=$rLogin['ip']?>
                        </td>
                        <td class="d-none d-sm-table-cell">
                          <?php echo date("m-d-Y, h:i:s a" ,$rLogin['date']);	 ?>
                        </td>
                        <td class="d-none d-sm-table-cell">
                          <?=$rLogin['country']?>
                        </td>
