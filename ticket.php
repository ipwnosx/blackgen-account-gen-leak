...
if ($getTicket['username'] != $_SESSION['username']) {
  header('Location: support.php');
}
?>
          ...
          <div class="block block-fx-pop">
              <div class="block-content block-content-full">
                <form method="post" action="inc/form/form.php">
                  <textarea class="js-summernote" data-height="100" name="message"></textarea>
                  <input type="hidden" name="id" value="<?=$id?>">
                  <button name="repondreticket" type="submit" class="btn btn-hero-sm btn-hero-primary mt-2">Envoyer</button>
                  <button name="fermerticket" type="submit" class="btn btn-hero-sm btn-hero-danger mt-2">Fermer le ticket</button>
                </form>
              </div>
          </div>
        <?php } else { ?>
